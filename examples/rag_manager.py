...
class RAGManager:
    ...
    def _index_domain(self, domain: str):
        ...
        try:
            ...
            print(f"Indexed {len(self.domain_indices[domain])} chunks for domain '{domain}'")
    ...
    def multi_domain_retrieve(self, query: str, domains: List[str], top_k_per_domain: int = 2) -> Dict[str, List[Dict[str, Any]]]:
    ...
    def multi_domain_retrieve_formatted(self, query: str, domains: List[str], top_k_per_domain: int = 2) -> str:
